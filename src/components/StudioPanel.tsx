    ...
    <div class="h-full flex flex-col bg-white/70 backdrop-blur-xl border border-white overflow-hidden shadow-lg rounded-3xl">
      ...
      <div class="flex-1 overflow-y-auto p-4 sm:p-6 space-y-8 bg-slate-50/50">
        ...
        <div class="grid grid-cols-2 gap-3 sm:gap-4">
          <button class="group relative bg-white border border-slate-200 hover:border-sky-300 flex flex-col items-start p-5 rounded-2xl shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300">
            ...
            <span class="text-sm font-bold text-slate-800 group-hover:text-sky-600 transition-colors">Audio Overview</span>
          ...
          <button class="group relative bg-white border border-slate-200 hover:border-amber-300 flex flex-col items-start p-5 rounded-2xl shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300">
            ...
            <span class="text-sm font-bold text-slate-800 group-hover:text-amber-600 transition-colors">Slide Deck</span>
            <div class="absolute top-4 right-4 bg-slate-100 text-slate-400 p-1.5 rounded-md opacity-0 group-hover:opacity-100 transition-opacity">
              <span class="iconify text-xs lucide--plus" />
            </div>
          </button>
          
          <button class="group relative bg-white border border-slate-200 hover:border-green-300 flex flex-col items-start p-5 rounded-2xl shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300">
            ...
            <span class="text-sm font-bold text-slate-800 group-hover:text-green-600 transition-colors">Video Guide</span>
            <div class="absolute top-4 right-4 bg-slate-100 text-slate-400 p-1.5 rounded-md opacity-0 group-hover:opacity-100 transition-opacity">
              <span class="iconify text-xs lucide--plus" />
            </div>
          </button>
          
          <button class="group relative bg-white border border-slate-200 hover:border-fuchsia-300 flex flex-col items-start p-5 rounded-2xl shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300">
            ...
            <span class="text-sm font-bold text-slate-800 group-hover:text-fuchsia-600 transition-colors">Reports</span>
            <div class="absolute top-4 right-4 bg-slate-100 text-slate-400 p-1.5 rounded-md opacity-0 group-hover:opacity-100 transition-opacity">
              <span class="iconify text-xs lucide--plus" />
            </div>
          </button>
        ...
        <div class="flex items-center gap-3">
          ...
          <span class="text-xs font-bold uppercase tracking-widest text-slate-400">Library History</span>
          <div class="h-px bg-slate-200 flex-1"></div>
        </div>
        ...
        <div class="space-y-3">
           <div class="flex items-start gap-4 group bg-white p-4 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md hover:border-slate-200 transition-all cursor-pointer">
              ...
              <div class="flex-1 min-w-0 py-1">
                <p class="text-[15px] font-bold text-slate-800 truncate leading-tight mb-1 group-hover:text-primary transition-colors">Saint Peter, Philosophy</p>
                <div class="flex items-center gap-2 text-xs font-medium text-slate-500">
                  <span class="bg-slate-100 px-2 py-0.5 rounded-md">9 sources</span>
                  <span>•</span>
                  <span>20d ago</span>
                </div>
              </div>
