...
| Building...                   | Attach                                                                                           |
| ----------------------------- | ------------------------------------------------------------------------------------------------ |
| AI agents / tools / workflows | `@Mastra Docs` + `src/mastra/index.ts` + the specific agent file                                 |
...
| Agent-UI integration          | `@Mastra Docs` + `@Hono Docs` + relevant agent + route files                                     |
